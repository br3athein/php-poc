 ...
 */
// slightly modified in comparison to original
...
abstract class Model
{
     ...
     * @return mixed
     */
    public static function sql ($sql, $return = Modelj::FETCH_MANY)
    {
        // shortcuts
    ...
    {
        $count = self::sql($sql, Model::FETCH_ONE);
    ...
    {
        self::sql('TRUNCATE :database.:table', Model::FETCH_NONE);
    }
    ...
    /**
     * Retrieve a record by a p100 22887  100 22887    0     0  37581      0 --:--:-- --:--:-- --:--:-- 37519
articular column name using the retrieveBy prefix.
     * e.g.
